...
class RoutineTableDataSource: NSObject, UITableViewDataSource {
    private var addedRoutine: Dictionary<WorkoutPart, [EachWorkoutRoutine]>?
    
    init(_ addedRoutine: Dictionary<WorkoutPart, [EachWorkoutRoutine]>) {
        self.addedRoutine = addedRoutine
    }

    func setAddedRoutine(_ addedRoutine: Dictionary<WorkoutPart, [EachWorkoutRoutine]>) {
        self.addedRoutine = addedRoutine
    }
